...
export const ShoppingBagIcon: React.FC<IconProps> = ({
  ...
  >
    ...
    <path d="M19.606 8.507l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007Z" />
    <circle cx="8.25" cy="10.5" r="0.375" />
    <circle cx="15.75" cy="10.5" r="0.375" />
  </svg>
);
